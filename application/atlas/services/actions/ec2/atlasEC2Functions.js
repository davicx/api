...
const AtlasPostFunctions = require('../../../aws/atlasClient/atlasPost');
const ScanEC2Functions = require('../../../aws/capabilities/scans/scanEC2');
...
//Function A4: Toggle EC2 — legacy shim; prefer capabilities/changes/changeEC2 (C7 removes)
async function toggleEC2(requestBody) {
    return ChangeEC2Functions.toggleEC2(requestBody);
}
