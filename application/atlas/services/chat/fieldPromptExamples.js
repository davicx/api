/*
FUNCTIONS A: Field prompt examples for chat (copy-paste format)
    1) Function A1: formatFieldPromptLine
    2) Function A2: buildMissingFieldPromptLines
    3) Function A3: buildMissingFieldsMessage
*/
...
//Function A1: One field line — field_name: "example"
function formatFieldPromptLine(fieldName, exampleValue) {
    return String(fieldName) + ': "' + String(exampleValue) + '"';
}

//Function A2: Lines for each missing field (registry override if already field: "value" shape)
...
//Function A3: Full block appended after started / acknowledgement copy
