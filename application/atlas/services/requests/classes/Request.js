...
Doc: application/atlas/doc/development/architecture.md (planning: current_development.md)
...
class Request {
    ...
    static async createAction({
        ...
        try {
            ...
            console.log('Request.createAction failed', err);
    ...
    static async getAction(workflowId) {
        ...
        try {
            ...
            console.log('Request.getAction failed', err);
    ...
    static async getOpenActionForConversation(conversationId) {
        ...
        try {
            ...
            console.log('Request.getOpenActionForConversation failed', err);
            return { success: false, action: null, errors: [err] };
        }
    }
    ...
    static async getAllOpenActions(conversationId) {
        ...
        try {
            ...
            console.log('Request.getAllOpenActions failed', err);
    ...
    static async getActionsByConversation(conversationId, options) {
        ...
        try {
            ...
            console.log('Request.getActionsByConversation failed', err);
            return { success: false, actions: [], errors: [err] };
        }
    }
    ...
    static async getActionsByOrganization(organization, options) {
        ...
        try {
            ...
            console.log('Request.getActionsByOrganization failed', err);
            return { success: false, actions: [], errors: [err] };
        }
    }
    ...
    static async getActionsByUser(requestedByUserName, options) {
        ...
        try {
            ...
            console.log('Request.getActionsByUser failed', err);
            return { success: false, actions: [], errors: [err] };
        }
    }
    ...
    static async getMissingActionInfo(conversationId) {
        const openResult = await Request.getAllOpenActions(conversationId);
    ...
    static async updateAction(workflowId, updates) {
        ...
        try {
            ...
            console.log('Request.updateAction failed', err);
            outcome.errors.push(err);
            return outcome;
        }
    }
    ...
    static async setField(workflowId, fieldName, fieldValue) {
        ...
        return Request.updateAction(workflowId, {
            collected: collected,
            missing: missing
        });
    }
    ...
    static async markAsked(workflowId, fieldName) {
        ...
        return Request.updateAction(workflowId, { asked: asked });
    }
    ...
    static async finishAction(workflowId, status, outcomeCode) {
        ...
        try {
            ...
            console.log('Request.finishAction failed', err);
            outcome.errors.push(err);
            return outcome;
        }
    }
    ...
    static async cancelAction(workflowId) {
        return Request.finishAction(workflowId, 'cancelled', 'cancelled_by_user');
    }
}

//FUNCTIONS B: Request DB helpers (file-local — not functions/functions.js AWS extractors)
