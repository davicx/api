...
> **Note:** [long_term/remediations.md](./long_term/remediations.md) still describes an older `create_ec2` + JSON intent path. **Locked MVP demo uses toggle + Terraform tfvars instead.**
