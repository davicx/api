...
| [Important Fixes](./feature_important_fixes.md) | Message / Response / Message Reply vocabulary; Request Message Reply naming. | **Step 5** — 8 locks; optional `speakRequest` or apply later |
