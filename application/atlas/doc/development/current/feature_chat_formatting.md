...
Makes CloudPilot chat replies easier to read with bold text, bullets, and line breaks.

## Current step

**Step 1 — Render formatted CloudPilot text in Kite.**

## Next

Step 2 — Send simple formatted text from the API.

**Status:** Active  
**Related:** [Current Development](./current_development.md) · Chat UI: `kite/src/pages/ChatPage.js`
