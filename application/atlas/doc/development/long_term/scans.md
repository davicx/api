...
> **Shipped:** [finished.md](./finished.md) · **Deferred:** [future_work.md](./future_work.md)
...
Details in [finished.md](./finished.md) (shipped) and sections below (next).
...
**Next:** no snapshot, oversized recommendation → [future_work.md](./future_work.md)
...
**Next rules (pick 2–3):** public bucket/policy, versioning disabled, logging disabled, missing tags → [future_work.md](./future_work.md)
...
Intent chat (“show security issues”, “ways to save money”), multi-service `scan_aws` dashboard summary, pipeline scan, extra rules, skipped AWS services — [future_work.md](./future_work.md#scans).
