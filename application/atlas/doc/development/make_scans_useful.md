...
> **Scanner status:** [scans.md](./scans.md) · **Shipped:** [finished.md](./finished.md) · **Later:** [future_work.md](./future_work.md)
...
- [future_work.md](./future_work.md) — deferred platform items  
