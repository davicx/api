...
> **Chat & AI (part of this work):** [current.md](./current.md)  
> **Architecture & how-to:** [architecture/architecture.md](../architecture/architecture.md)  
> **Deferred:** [future/to_do.md](../future/to_do.md) · [future/scans.md](../future/scans.md) · [future/remediations.md](../future/remediations.md)
...
> **Full checklist:** [pr_strategy.md](./pr_strategy.md) — use **Steps 0–7** there (simple numbers).
...
**Infra repo:** [`cloudpilot_infrastructure`](../../../../../cloudpilot_infrastructure) — demo-only. Keep it tiny under `environments/kite/` (see pr_strategy.md).

**Same pattern as CLI:** `pr.js` → toggle builder → GitHub client.  
String replace one value. No OpenAI. No Terraform parser for MVP.

Follow [pr_strategy.md](./pr_strategy.md) Steps **0 → 7**. Do not use lettered codes.
...
### M7 — CloudPilot Chat / AI ([current.md](./current.md))
...
| Doc | Role |
|-----|------|
| [current.md](./current.md) | AI — live + planned (region, Features 1–3) — **M7** |
