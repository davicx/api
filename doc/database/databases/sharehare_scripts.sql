...
#DELETE FROM shareshare.posts WHERE post_id > 10
#DELETE FROM user_profile WHERE user_profile_id > 197
#DELETE FROM user_login WHERE user_id > 46
...
##LOGIN##
#SELECT * from user_profile;
#DELETE FROM user_profile WHERE user_profile_id > 200
#SELECT * from user_login;
#DELETE FROM user_login WHERE user_id > 60
...
#UPDATE user_profile SET image_name = "http://localhost:3003/images/background_2.png" WHERE user_profile_id = 192
SELECT * FROM user_profile WHERE user_name = "davey"

#ALTER TABLE user_profile CHANGE COLUMN cloud_path cloud_key VARCHAR(255) AFTER cloud_bucket;

#ALTER TABLE user_profile DROP COLUMN file_url;

#ALTER TABLE posts CHANGE COLUMN file_name_server file_name_server VARCHAR(255) AFTER file_name;
#ALTER TABLE user_profile CHANGE COLUMN cloud_bucket cloud_bucket VARCHAR(255) AFTER biography;
#ALTER TABLE user_profile CHANGE COLUMN image_name image_name VARCHAR(255) AFTER email;
#SELECT * FROM posts

#ALTER TABLE user_profile ADD file_name_server varchar(255) DEFAULT "file_name_server" AFTER file_name;
...
#http://localhost:3003/images/background_2.png
