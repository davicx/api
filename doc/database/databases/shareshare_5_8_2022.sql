...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 09, 2022 at 12:17 AM
...
INSERT INTO `comments` (`comment_id`, `post_id`, `comment`, `comment_from`, `comment_deleted`, `updated`, `created`) VALUES
(117, 1, 'Hiya sam! I do want to go!', 'david', 0, '2021-11-21 23:39:11', '2021-11-21 23:39:11'),
(118, 1, 'Cool how fun! ', 'sam', 0, '2021-11-21 23:39:11', '2021-11-21 23:39:11');
...
CREATE TABLE IF NOT EXISTS `comments_original` (
  `comment_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
...
INSERT INTO `comments_original` (`comment_id`, `group_id`, `post_id`, `comment_is_child`, `comment`, `comment_from`, `likes`, `has_file`, `file_id`, `file_name`, `file_name_server`, `comment_deleted`, `updated`, `created`) VALUES
...
CREATE TABLE IF NOT EXISTS `group_users` (
  ...
  `is_default_group` int(11) NOT NULL DEFAULT 0,
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`primary_id`)
...
(1004, 70, 'davey', 1, '0000-00-00 00:00:00', 0, '2021-12-19 01:20:57'),
(1005, 70, 'frodo', 1, '0000-00-00 00:00:00', 0, '2021-12-19 01:20:57'),
(1006, 70, 'sam', 1, '0000-00-00 00:00:00', 0, '2021-12-19 01:20:57'),
(1007, 70, 'merry', 0, '0000-00-00 00:00:00', 0, '2021-12-19 01:21:02'),
(1008, 70, 'pippin', 0, '0000-00-00 00:00:00', 0, '2021-12-19 01:21:02'),
(1009, 412, 'davey', 1, '0000-00-00 00:00:00', 0, '2022-01-09 00:03:23'),
(1010, 412, 'sam', 0, '0000-00-00 00:00:00', 0, '2022-01-09 00:03:23'),
(1011, 412, 'frodo', 1, '0000-00-00 00:00:00', 0, '2022-01-09 00:03:23'),
(1012, 412, 'merry', 0, '0000-00-00 00:00:00', 0, '2022-01-09 00:04:31'),
(1013, 412, 'pippin', 0, '0000-00-00 00:00:00', 0, '2022-01-09 00:04:31');
...
INSERT INTO `notifications` (`notification_id`, `master_site`, `group_id`, `notification_from`, `notification_to`, `notification_type`, `notification_message`, `notification_time`, `notification_link`, `notification_seen`, `notification_deleted`) VALUES
(1860, 'kite', 70, 'davey', 'frodo', 'new_post_photo', 'Posted a Photo', '2022-01-09 00:00:55', 'http://localhost:3003/posts/group/77', 0, 0),
(1861, 'kite', 70, 'davey', 'sam', 'new_post_photo', 'Posted a Photo', '2022-01-09 00:00:55', 'http://localhost:3003/posts/group/77', 0, 0),
(1862, 'kite', 412, 'davey', 'sam', 'group_invite', 'Invited you to a new Group', '2022-01-09 00:03:23', 'http://localhost:3003/group/77', 0, 0),
(1863, 'kite', 412, 'davey', 'frodo', 'group_invite', 'Invited you to a new Group', '2022-01-09 00:03:23', 'http://localhost:3003/group/77', 1, 0),
(1864, 'kite', 412, 'davey', 'merry', 'group_invite', 'Invited you to a new Group', '2022-01-09 00:04:31', 'http://localhost:3003/group/79', 0, 0),
(1865, 'kite', 412, 'davey', 'pippin', 'group_invite', 'Invited you to a new Group', '2022-01-09 00:04:31', 'http://localhost:3003/group/79', 0, 0),
(1869, 'kite', 412, 'frodo', 'davey', 'accepted_group_invite', 'frodo accepted your Group Invite', '2022-01-10 01:11:58', 'http://localhost:3003/group/412', 0, 0);
...
CREATE TABLE IF NOT EXISTS `notifications_original` (
  `notification_id` int(11) NOT NULL AUTO_INCREMENT,
  `master_site` varchar(255) NOT NULL,
...
INSERT INTO `notifications_original` (`notification_id`, `master_site`, `status_unseen`, `notification_from`, `notification_to`, `notification_type`, `notification_message`, `notification_time`, `full_link`, `link_url`, `group_id`, `list_id`, `from_logged_in_user`, `notification_count`, `notification_deleted`, `clicked`) VALUES
...
INSERT INTO `pending_requests` (`request_id`, `master_site`, `request_type`, `request_type_text`, `request_is_pending`, `sent_by`, `sent_to`, `request_key`, `sent_to_email`, `friend_id`, `group_id`, `list_id`, `updated`, `created`) VALUES
(799, 'kite', 'new_group', 'invited you to join a group', 1, 'davey', 'sam', 'key', 'false', 0, 412, 0, '2022-01-09 00:03:23', '2022-01-09 00:03:23'),
(800, 'kite', 'new_group', 'invited you to join a group', 0, 'davey', 'frodo', 'key', 'false', 0, 412, 0, '2022-01-09 00:03:23', '2022-01-09 00:03:23'),
(801, 'kite', 'group_invite', 'invited you to join a group', 1, 'davey', 'pippin', 'key', 'false', 0, 412, 0, '2022-01-09 00:04:31', '2022-01-09 00:04:31'),
(802, 'kite', 'group_invite', 'invited you to join a group', 1, 'davey', 'merry', 'key', 'false', 0, 412, 0, '2022-01-09 00:04:31', '2022-01-09 00:04:31');
...
INSERT INTO `posts` (`post_id`, `master_site`, `post_type`, `post_status`, `group_id`, `list_id`, `post_from`, `post_to`, `post_caption`, `file_name`, `file_name_server`, `file_url`, `video_url`, `video_code`, `updated`, `created`) VALUES
(254, 'kite', 'text', 1, 77, 0, 'davey', 'frodo', 'Hiya Frodo!! The weather is perfect! wanna hike or we could garden!', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2021-12-19 00:14:03', '2021-12-19 00:14:03'),
(255, 'kite', 'video', 1, 77, 0, 'davey', 'frodo', 'Hiya!! Check out this Video!', '', 'hiya.jpg', 'empty', 'https://www.youtube.com/watch?v=niCMpOkMcWU', 'niCMpOkMcWU', '2021-12-19 00:14:29', '2021-12-19 00:14:29'),
(256, 'Kite', 'photo', 1, 77, 0, 'davey', '77', 'Hiya Sam!! ', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2021-12-19 00:15:31', '2021-12-19 00:15:31'),
(257, 'Kite', 'photo', 1, 77, 0, 'davey', '77', 'Hiya Sam!! ', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2022-01-08 23:42:58', '2022-01-08 23:42:58'),
(258, 'Kite', 'photo', 1, 77, 0, 'davey', '77', 'Hiya Sam!! ', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2022-01-08 23:43:37', '2022-01-08 23:43:37'),
(259, 'Kite', 'photo', 1, 77, 0, 'davey', '77', 'Hiya Sam!! ', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2022-01-08 23:44:14', '2022-01-08 23:44:14'),
(260, 'Kite', 'photo', 1, 77, 0, 'davey', '77', 'Hiya Sam!! ', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2022-01-09 00:00:14', '2022-01-09 00:00:14'),
(261, 'Kite', 'photo', 1, 70, 0, 'davey', '70', 'Hiya Sam!! ', '', 'hiya.jpg', 'empty', 'empty', 'empty', '2022-01-09 00:00:55', '2022-01-09 00:00:55');
...
INSERT INTO `posts_full` (`post_id`, `master_site`, `post_type`, `post_status`, `parent`, `group_id`, `board_id`, `list_id`, `post_from`, `post_to`, `post_caption`, `post_url`, `post_url_caption`, `video_code`, `image_url`, `file_url`, `file_name`, `file_name_server`, `article_title`, `article_text`, `contains_file`, `unique_id`, `comment_seen`, `updated`, `created`) VALUES
(143, 'kite', 'text', 0, 0, 0, 0, 0, 'davey', '77', 'Hi sam this is new! Do you wanna garden today again! The weather is perfect! Or we could hike!', '', '', '', '', '', '', '', '', '', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(144, 'kite', 'text', 0, 0, 0, 0, 0, 'davey', '77', 'Hi frodo do you wanna garden today?! The weather is perfect! Or we could fish!', '', '', '', '', '', '', '', '', '', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `refresh_tokens` (`token_id`, `refresh_token`, `token_created`) VALUES
(3, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjdXJyZW50VXNlciI6eyJ1c2VySUQiOjEsInVzZXJuYW1lIjoiZGF2ZXkiLCJlbWFpbCI6Im15cGFzc3dvcmQifSwiaWF0IjoxNjUxOTY4OTc0fQ.kNpXUUeQ8V4uLNhEtNdkmnHdPDY6sBoddM2SiLjAZfE', '2022-05-08 00:16:15');
...
(1, 'vasquezd', 'vasquezd@onid.orst.edu', '1494015793', 'c3be883dd5822f892141e642962084d6be47c2bf', '2021-11-05 23:51:08', '2019-08-26 23:30:25', 950, 0, 'A2XMVdcf3SNCMpkIJQqxbnSOfPcGIHul', '2017-05-06 03:28:32', 0, '1'),
...
(26, 'davey', 'davey@gmail.com', '$2b$10$WJw1mahKgiXQWdoV/eOEX.', '$2b$10$WJw1mahKgiXQWdoV/eOEX.NGdMsZgIF/nkV6Cn.2Zbjp945yNHhwq', '2022-03-06 00:25:39', '0000-00-00 00:00:00', 0, 0, 'null', '0000-00-00 00:00:00', 0, 'null');
...
CREATE TABLE IF NOT EXISTS `user_profile` (
  ...
  `biography` text NOT NULL DEFAULT '"bio"',
...
INSERT INTO `user_profile` (`user_profile_id`, `user_id`, `user_name`, `email`, `image_name`, `first_name`, `last_name`, `root_folder`, `biography`, `university`, `post_view`, `account_active`, `updated`, `created`) VALUES
(46, 1, 'vasquezd', 'Vasquezd@onid.orst.edu', '12.jpg', 'David', 'Vasquez', 'Vasquezd', 'My Biography', 'Oregon State ', 'large', 1, '2016-04-04 04:33:50', '2014-08-22 01:00:05'),
(47, 2, 'matt', 'vasquezm@shareshare.com', 'matt.jpg', 'Matt', 'Vasquez', '', 'This is matts page!', '', '', 1, '2015-12-01 12:55:10', '0000-00-00 00:00:00'),
(48, 3, 'brian', 'vasquezb@shareshare.com', '13.jpg', 'Brian', 'Vasquez', '', 'this is brian\'s page! ', '', '', 1, '2016-04-10 04:02:59', '0000-00-00 00:00:00'),
(49, 4, 'Kristen', 'vasquezj@shareshare.com', 'david.jpg', 'Kristen', 'Vasquez', '', 'this is my page!', '', '', 1, '2015-12-03 11:25:43', '0000-00-00 00:00:00'),
(50, 5, 'Aimee', 'Aimeeaileen@mac.com', '11.jpg', 'Aimee', 'Vasquez', 'Vasquez', 'They are (or were) a little people, about half our height, and smaller than the bearded dwarves. \n	Hobbits have no beards. There is little or no magic about them except the ordinary everyday sort which helps \n	them to disappear quietly and quickly when large stupid folk like you and me come blundering along, \n	making a noise like elephants which they can hear a mile off <- Not your bio change it here', '', '', 1, '2015-12-07 16:28:40', '0000-00-00 00:00:00'),
(51, 6, 'Becca', '', 'Becca.jpg', 'Becca', 'Vasquez', 'vasquezma', 'They are (or were) a little people, about half our height, and smaller than the bearded dwarves. \r\n	Hobbits have no beards. There is little or no magic about them except the ordinary everyday sort which helps \r\n	them to disappear quietly and quickly when large stupid folk like you and me come blundering along, \r\n	making a noise like elephants which they can hear a mile off <- Not your bio change it here', '', '', 1, '2016-04-10 04:03:19', '0000-00-00 00:00:00'),
(52, 7, 'Sarah', '', '11.jpg', 'Sarah', 'Vasquez', 'Vasquezbb', 'They are (or were) a little people, about half our height, and smaller than the bearded dwarves. \r\n	Hobbits have no beards. There is little or no magic about them except the ordinary everyday sort which helps \r\n	them to disappear quietly and quickly when large stupid folk like you and me come blundering along, \r\n	making a noise like elephants which they can hear a mile off <- Not your bio change it here', '', '', 1, '2015-12-01 12:57:23', '0000-00-00 00:00:00'),
(78, 26, 'davey', 'davey@gmail.com', 'frodo.jpg', 'davey', 'v', 'davey', 'They are (or were) a little people, about half our height, and smaller than the bearded dwarves', '\"osu\"', '\"nada\"', 1, '2022-03-06 00:25:39', '2022-03-06 00:25:39');
