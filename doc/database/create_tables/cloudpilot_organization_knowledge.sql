-- =============================================================================
-- cloudpilot_organization_knowledge + cloudpilot_organization_knowledge_tags
-- =============================================================================
--
...
--
-- Rename from legacy names (if needed):
--   mysql -u USER -p DATABASE_NAME < doc/sql/alter/organization_knowledge_rename_cloudpilot.sql
--
